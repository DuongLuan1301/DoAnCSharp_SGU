...
- Quản trị viên (Admin): Hệ thống cung cấp giao diện quản trị để quản lý (CRUD) các dữ liệu hàng quán. Đảm bảo dữ liệu quán được kiểm soát và chỉ hiển thị trên ứng dụng khi đã được phê duyệt.
